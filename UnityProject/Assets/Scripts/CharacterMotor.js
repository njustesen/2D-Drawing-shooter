...
private function UpdateFunction () {
	...
	var oldHVelocity : Vector3 = new Vector3(velocity.x, 0, 0);
	movement.velocity = (tr.position - lastPosition) / Time.deltaTime;
	var newHVelocity : Vector3 = new Vector3(movement.velocity.x, 0, 0);
...
private function ApplyInputVelocityChange (velocity : Vector3) {	
	...
	if (grounded && TooSteep()) {
		...
		desiredVelocity = Vector3(groundNormal.x, 0, 0).normalized;
		// Find the input movement direction projected onto the sliding direction
		var projectedMoveDir = Vector3.Project(inputMoveDirection, desiredVelocity);
		// Add the sliding direction, the spped control, and the sideways control vectors
		desiredVelocity = desiredVelocity + projectedMoveDir * sliding.speedControl + (inputMoveDirection - projectedMoveDir);
