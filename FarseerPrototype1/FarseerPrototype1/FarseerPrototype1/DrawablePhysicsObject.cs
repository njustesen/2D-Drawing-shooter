...
namespace FarseerPrototype1 {
    public class DrawablePhysicsObject
    {
        ...
        public DrawablePhysicsObject(World world, Texture2D texture, Vector2 size)
        {
            this.Size = size;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture, Position, null, Color.White, body.Rotation, new Vector2(texture.Width / 2.0f, texture.Height / 2.0f), scale, SpriteEffects.None, 0f);
        }
    }
}
